...
//Test Case 8: Let's see the results of right multiplication
TEST(MatrixMultiplicationTest, TestRightMultiplication) {
    std::vector<std::vector<int>> A = {
        {1, 2, 3},
        {4, 5, 6}            
    };                        
    ...
    EXPECT_EQ(expected, expected) << "Matrix multiplication test failed! :(((()";
}
